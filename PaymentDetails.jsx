...
const CheckoutPage = () => {
  ...
  const handleConfirmPayment = () => {
    // If "add-card" is selected, validate card details first
  ...
  />
        ...
        <div className="mt-8 flex justify-end">
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1"
          >
            Confirm Payments
          </button>
        </div>
